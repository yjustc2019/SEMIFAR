...
plot.trend <- ggplot(df, aes(x = year, y = y)) + 
  ...
  labs(title = "(a) Log of air pollution (PM25) & estimated trend", y = "Log-Air Pollution - PM25", x = "") + 
...
ggsave("London_AirQuality_PM25_2.pdf", height = 5, width = 9.5, dpi = 600)
